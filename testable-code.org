...
construct links, thus we can build email message containing confirmation URL
there and pass it to =mailer=, which might have a lot more generic interface, for
